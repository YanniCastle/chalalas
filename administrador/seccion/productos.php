    ...
    <div class="card-body">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="hidden" required readonly class="form-control" value="<?php echo $txtID; ?>" name="txtID"
            id="txtID" placeholder="ID">
        </div>
        <!--Agregue ID_USER-->
        <div class="form-group">
          <!--<label for="ID_USER">ID_USER:</label>-->
          <input type="hidden" required readonly class="form-control" value="<?php echo $id; ?>" name="ID_USER"
