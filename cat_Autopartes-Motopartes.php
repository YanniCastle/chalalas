...
<head>
  ...
  <title>Autopartes-Motopartes</title>
</head>
...
///////////////////CATEGORIA:Autopartes-Motopartes/////////////////////////
$Categoria = "Autopartes-Motopartes";//Probando muestreos
echo "<div class='tcategorias'>".htmlspecialchars($Categoria)."</div>";
$sentenciaSQL5 = mysqli_query($con, "SELECT * FROM libros WHERE categoria LIKE '%$Categoria%' ");

if ($sentenciaSQL5->num_rows > 0) {
  echo "<div class='productos-container'>"; // Contenedor general

  while ($row = $sentenciaSQL5->fetch_array()) {
...
/////////////////////FIN DE CATEGORIA:Autopartes-Motopartes//////////////////////////
?>
