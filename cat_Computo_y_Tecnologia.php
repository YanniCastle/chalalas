...
<head>
  ...
  <title>Computo y Tecnologia</title>
</head>
...
///////////////////CATEGORIA:Hogar/////////////////////////
$Categoria = "Computo y Tecnologia";//Probando muestreos
echo "<div class='tcategorias'>".htmlspecialchars($Categoria)."</div>";
$sentenciaSQL6 = mysqli_query($con, "SELECT * FROM libros WHERE categoria LIKE '%$Categoria%' ");

if ($sentenciaSQL6->num_rows > 0) {
  echo "<div class='productos-container'>"; // Contenedor general

  while ($row = $sentenciaSQL6->fetch_array()) {
