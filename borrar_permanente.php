...
<body>
  ...
  echo "<br/><br/><br/><h2>Usuari@ " . $_SESSION["usuario"] . "!<br></h2>";
  ...
  ?>
  <h1>Se borraran todos tus datos, fotos y cuenta de usuario, si desear borrar todo presiona el boton "Borrar cuenta permanentemente"</h1>
  <form method="post" action="eliminacion_de_ cuenta.php?id=<?php echo $id; ?>& rutauno=<?php echo $rutafoto1; ?>& rutados=<?php echo $rutafoto2; ?>& rutatres=<?php echo $rutafoto3; ?>& rutacuatro=<?php echo $rutafoto4; ?>">
    <table class="uno">
      <tr>
        <td>
          <button type="submit" name="eliminar_imagen">Borrar cuenta permanentemente</button>
        </td>
      </tr>
    </table>
  </form>
