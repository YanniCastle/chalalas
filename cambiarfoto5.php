...
<head>
	...
	<link rel="stylesheet" type="text/css" href="formulario_imagenes.css"><!--formulario Imagenes-->
...
<body>
  ...
  //FIN DE ESTRUCTURA DE BUSCADOR//
	...
	?>
	<!--/ / / / / Formulario foto 1 / / / / / / / / / / / / / / / / / /-->
	<form action="foto5.php" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<input type='submit' name='btn_enviar' id="btn_enviar" value='Subir'>
				</td>
			</tr>
		</table>
	</form>
