...
$Categoria = "Antiguedades";//Probando muestreos
echo "<div class='tcategorias'>".htmlspecialchars($Categoria)."</div>";
$sentenciaSQL1 = mysqli_query($con, "SELECT * FROM libros WHERE categoria LIKE '%$Categoria%' ");

if ($sentenciaSQL1->num_rows > 0) {
  echo "<div class='productos-container'>"; // Contenedor general

  while ($row = $sentenciaSQL1->fetch_array()) {
